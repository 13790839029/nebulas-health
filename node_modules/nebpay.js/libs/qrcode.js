...
<<<<<<< HEAD
  ...
  addCssRule(".qrcode", canvasStyle);
	...
	var style = 'text-align: center;   background-color: #fff0;    border-radius: 20px;    width: 300px;    height: 300px;    position: absolute;    left: 50%;    top: 50%;    transform: translate(-50%,-50%);';
=======
	var canvasStyle = `box-shadow: 2px 2px 12px lightgray;`;
	addCssRule(".qrcode", canvasStyle);
...
<<<<<<< HEAD
	style = 'position:absolute;	left:0;	top:0;	z-index:100;	height:100%;	width:100%;	background-color: rgba(0, 0, 0, 0.4);';
=======
